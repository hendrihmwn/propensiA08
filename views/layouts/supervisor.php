            ...
            <div class="navbar-defaultnew sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						<li>
							<a href="<?= Yii::$app->params['base']?>web/safety-inventory"><i class="fa fa-bar-chart-o fa-fw"></i> Inventory<span class="fa "></span></a>
						</li>
						<li>
						...
						<li>
							<a href="<?= Yii::$app->params['base']?>web/pesan"><i class="fa fa-edit fa-fw"></i> Pesan<span class="fa "></span></a>
